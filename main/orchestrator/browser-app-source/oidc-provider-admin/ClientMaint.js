...
var ClientMaint = createReactClass({
  ...
  render: function() {
    ...
    if (this.state.status === 'userMaint') {
      return (
        <UserMaint
    ...
    return (
      <span>
        ...
        <Modal
          container = {document.body}
          show = {this.show.credentials}
        >
          <Modal.Header>
            <Modal.Title>Basic Authentication Credentials</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <center>
              When using REST APIs for this Client that require
              Basic Authentication, use the following value for

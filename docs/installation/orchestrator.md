# Multiple Server Architecture: Configuring and Running the Orchestrator
...
In fact, if you look in the */main/configuration* folder, you'll find an example template version 
...
## Copy the Settings File to your other Servers


You now need to physically
copy the *settings.json* file from the Orchestrator to each of the other machines on which
you'll be running the Platform's other MicroServices.  
...
Start the Orchestrator Docker Container using the command:

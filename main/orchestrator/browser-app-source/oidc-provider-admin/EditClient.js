        ...
        >
          ...
          <Panel.Body>
            ...
            <FormField
              ...
              label='User Interface HomePage URL'
              type='text'
              controller = {this.controller}
              focus={false}
              value = {this.props.data.home_page_url}
              formModule = 'EditClient'
            />
            <FormField
              fieldname='login_form_title'
              label='OIDC Provider Login Form Title'
              type='text'
              controller = {this.controller}
              focus={false}
              value = {this.props.data.login_form_title}
              formModule = 'EditClient'
            />

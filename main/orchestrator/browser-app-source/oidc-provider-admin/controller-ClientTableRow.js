...
module.exports = function (controller) {
  ...
  this.displayCredentials = function() {
    controller.emit('displayCredentials', self.props.data);
  }

  this.deleteClient = function() {
    console.log('data: ' + JSON.stringify(self.props.data, null, 2));
    controller.emit('deleteThisClient', self.props.data);
  }

  this.editClient = function() {
    console.log('data: ' + JSON.stringify(self.props.data, null, 2));
    controller.emit('editClient', self.props.data);
  }

  this.maintainUsers = function() {
    controller.emit('maintainUsers', self.props.data);
  }

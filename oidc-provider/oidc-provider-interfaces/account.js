    ...
    static async findById(ctx, id) {
      ...
      return {
        ...
        async claims(use, scope, claims, rejected) {
          console.log('findById claims...');
          console.log('use = ' + use);
          console.log('scope = ' + scope);
          console.log('claims: ' + JSON.stringify(claims, null, 2));
          console.log('rejected: ' + JSON.stringify(rejected, null, 2));

          var auth = ctx.request.header.authorization.split('Basic ')[1];
          var client_id = Buffer.from(auth, 'base64').toString();
          ...
          console.log('** results returned from claims function: ' + JSON.stringify(results, null, 2));
          return results;
        }
      };

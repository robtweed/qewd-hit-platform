...
module.exports = function(ehrId, templateName, sessionId, version, callback) {
  if (!callback) {
    callback = version;
  }
  ...
  aql = aql + ' contains COMPOSITION a where a/name/value = ';
  aql = aql + "'" + templateName + "'";
  ...
  //console.log('OpenEHR Get Patient Compositions By Template Name: ' + JSON.stringify(options, null, 2));
  request(options, function(error, response, body) {
    console.log('OpenEHR Get Patient Compositions By Template Name: ' + JSON.stringify(response, null, 2));
